...
def optimization_leaky_singlemode(
    ...
    for mode_index in mode_index_set:
        ...
        save_fig_param = {
            'save_fig': save_fig,
            'fig_name': f"TF_seeing_{init_params['seeing']}_mode_{mode_index}_leaky.png",
        ...
        save_fig_param = {
            'save_fig': save_fig,
            'fig_name': f"PSD_seeing_{init_params['seeing']}_mode_{mode_index}_leaky.png",
            'fig_folder': os.path.join(DEFAULT_FIG_PATH, 'figures'),
            'dpi': 300
        }
    ...
    if save_table is True: 
        ...
        table_name =f"Result_seeing_{init_params['seeing']}_leaky_{timestamp}.xlsx"
...
if __name__ == "__main__":
    obj_to_optimize = optimization_leaky_singlemode(
        param_dir = 'params_mod4_leaky_seeing_0.6.yaml',
        mode_index_set=[2], 
        save_fig=True,
        save_table=True,
        show_fig=False)
