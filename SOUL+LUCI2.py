...
with open("params_Total_variance_SOUL+LUCI2_modified.yaml", "w") as file:
...
result = run("params_Total_variance_SOUL+LUCI2_modified.yaml")

print(result)


# FARE TABELLA CON RISULTATI CASO PROVA  
